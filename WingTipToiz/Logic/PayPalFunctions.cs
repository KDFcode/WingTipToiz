...
namespace WingTipToiz.Logic
{
    ...
    public class NVPAPICaller
    {
        ...
        public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
        {
            ...
            string returnURL = "https://localhost:44308/Checkout/CheckoutReview.aspx"; //valjda https://localhost:44308 kod mene pa isti nastavak nek je
            string cancelURL = "https://localhost:44308/Checkout/CheckoutCancel.aspx"; //https://learn.microsoft.com/en-us/aspnet/web-forms/overview/getting-started/getting-started-with-aspnet-45-web-forms/checkout-and-payment-with-paypal#update-the-localhost-port-number-in-the-paypal-class 
            //sustinski isto kaze i taj deo tutorijala budimo fer
            ...
            using (WingTipToiz.Logic.ShoppingCartActions myCartOrders = new WingTipToiz.Logic.ShoppingCartActions())
            {
